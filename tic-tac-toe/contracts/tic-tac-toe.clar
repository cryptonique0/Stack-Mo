;; title: tic-tac-toe
;; version: 1.0.0
;; summary: a tic tac toe game built using Clarity and deployed on the Stacks blockchain.
;; description: a contract that allows players to play tic tac toe against each other.
